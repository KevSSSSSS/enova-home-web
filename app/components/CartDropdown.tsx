...
export default function CartDropdown({ abierto }: Props) {
    ...
    return (
        <div
            className="absolute top-full right-0 mt-4 w-[380px] bg-white rounded-lg shadow-2xl border border-gray-200 z-50"
        >
            {/* Flecha */}
            ...
            <div className="p-4">
                <button
                    className="w-full h-12 rounded-md bg-[#6B705C] text-white hover:bg-[#3E4234] transition"
                >
                    Ver carrito
                </button>
            </div>
