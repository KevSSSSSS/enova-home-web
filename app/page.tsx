    ...
    <div className="min-h-screen flex flex-col bg-[#FFFFFF] text-[#3E4234] font-[var(--font-montserrat)]">
      ...
      <section className="grid md:grid-cols-2 gap-0 px-0 py-0 bg-[#FFFFFF] flex-grow items-center">
        ...
        <div className="space-y-6 px-12">
          <h2 className="text-5xl font-bold text-[#3E4234] font-playfair leading-tight">
            Detalles que<br /> hacen la diferencia
          </h2>
          <hr className="w-16 border-t-2 border-[#3E4234]" />
          <p className="text-lg text-[#6B705C] font-montserrat">
            Todo lo que necesitas para<br /> crear el hogar que amas.
          </p>
          <div className="flex gap-6">
            <button className="bg-[#3E4234] text-white px-6 py-3 rounded font-[var(--font-montserrat)] uppercase tracking-wide hover:bg-[#6B705C] transition">
              VER CATEGORÍAS
            </button>
            <button className="border border-[#3E4234] text-[#3E4234] px-6 py-3 rounded font-[var(--font-montserrat)] uppercase tracking-wide hover:bg-[#6B705C] hover:text-white transition">
              CONTÁCTANOS
            </button>
          </div>
        </div>
        ...
        <div className="relative w-full h-full">
          ...
          />
          {/* Degradado en el borde izquierdo hacia afuera */}
